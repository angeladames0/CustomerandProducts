...
import InterfazClientes.VentanaPrincipal;
	...
	public Productos() {
		...
		btnActualizar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ModificarProducto frmModificarProducto = new ModificarProducto();
		...
		btnEliminar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				EliminarProducto frmEliminarProducto = new EliminarProducto();
		...
		public static void TablaAct() {

		DBconexion conn = new DBconexion();
		Connection con = conn.getDBconexion();

		String sql = "SELECT nombreproducto, marcaproducto, categoriaproducto, precioproducto, stockproducto FROM productos" ;
